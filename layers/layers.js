...
var format_GPRAnomalies_3 = new ol.format.GeoJSON();
var features_GPRAnomalies_3 = format_GPRAnomalies_3.readFeatures(json_GPRAnomalies_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GPRAnomalies_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GPRAnomalies_3.addFeatures(features_GPRAnomalies_3);
var lyr_GPRAnomalies_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_GPRAnomalies_3, 
                style: style_GPRAnomalies_3,
                interactive: false,
    title: 'GPR Anomalies<br />\
    <img src="styles/legend/GPRAnomalies_3_0.png" /> 1<br />\
    <img src="styles/legend/GPRAnomalies_3_1.png" /> 2<br />\
    <img src="styles/legend/GPRAnomalies_3_2.png" /> 3<br />'
        });
...
var format_SearchableMarkers_9 = new ol.format.GeoJSON();
var features_SearchableMarkers_9 = format_SearchableMarkers_9.readFeatures(json_SearchableMarkers_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SearchableMarkers_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SearchableMarkers_9.addFeatures(features_SearchableMarkers_9);
var lyr_SearchableMarkers_9 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_SearchableMarkers_9, 
                style: style_SearchableMarkers_9,
                interactive: false,
                title: 'SearchableMarkers'
            });
var format_Fences_10 = new ol.format.GeoJSON();
var features_Fences_10 = format_Fences_10.readFeatures(json_Fences_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Fences_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Fences_10.addFeatures(features_Fences_10);
var lyr_Fences_10 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Fences_10, 
                style: style_Fences_10,
                interactive: false,
                title: '<img src="styles/legend/Fences_10.png" /> Fences'
            });
var format_Walls_11 = new ol.format.GeoJSON();
var features_Walls_11 = format_Walls_11.readFeatures(json_Walls_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Walls_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Walls_11.addFeatures(features_Walls_11);
var lyr_Walls_11 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Walls_11, 
                style: style_Walls_11,
                interactive: false,
                title: '<img src="styles/legend/Walls_11.png" /> Walls'
            });

lyr_GoogleRoad_0.setVisible(true);lyr_CemeteryBoundary_1.setVisible(true);lyr_GPRGrids_2.setVisible(true);lyr_GPRAnomalies_3.setVisible(true);lyr_PavedRoads_4.setVisible(true);lyr_MetalMarkers_5.setVisible(true);lyr_GardenofRemembrance_6.setVisible(true);lyr_IndividualGraves_7.setVisible(true);lyr_SharedMonuments_8.setVisible(true);lyr_SearchableMarkers_9.setVisible(false);lyr_Fences_10.setVisible(true);lyr_Walls_11.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_CemeteryBoundary_1,lyr_GPRGrids_2,lyr_GPRAnomalies_3,lyr_PavedRoads_4,lyr_MetalMarkers_5,lyr_GardenofRemembrance_6,lyr_IndividualGraves_7,lyr_SharedMonuments_8,lyr_SearchableMarkers_9,lyr_Fences_10,lyr_Walls_11];
...
lyr_GPRAnomalies_3.set('fieldAliases', {'Confidence': 'Confidence', 'Marker': 'Marker', 'Conf_Note': 'Conf_Note', 'GridNumber': 'GridNumber', });
...
lyr_SearchableMarkers_9.set('fieldAliases', {'Name(s)': 'Name(s)', });
lyr_Fences_10.set('fieldAliases', {'id': 'id', });
lyr_Walls_11.set('fieldAliases', {'id': 'id', });
lyr_CemeteryBoundary_1.set('fieldImages', {'id': '', 'Desc': '', 'Area': '', });
lyr_GPRGrids_2.set('fieldImages', {'Number': '', 'Label': '', });
lyr_GPRAnomalies_3.set('fieldImages', {'Confidence': '', 'Marker': '', 'Conf_Note': '', 'GridNumber': '', });
...
lyr_SearchableMarkers_9.set('fieldImages', {'Name(s)': '', });
lyr_Fences_10.set('fieldImages', {'id': '', });
lyr_Walls_11.set('fieldImages', {'id': '', });
...
lyr_GPRAnomalies_3.set('fieldLabels', {'Confidence': 'inline label', 'Marker': 'inline label', 'Conf_Note': 'inline label', 'GridNumber': 'inline label', });
...
lyr_SearchableMarkers_9.set('fieldLabels', {'Name(s)': 'inline label', });
lyr_Fences_10.set('fieldLabels', {'id': 'no label', });
lyr_Walls_11.set('fieldLabels', {'id': 'no label', });
lyr_Walls_11.on('precompose', function(evt) {
